...
--[[		print("Drs: " .. drs)
		print("Crs: " .. crs)
		print("Drs inside of HUD: " .. h.drNum)
		print("Blue accts: " .. blueAccts)
...
--	print("drs: " .. drs)
	...
	h.dr.isVisible = false
	h.numOfDrs.isVisible = false


	for i = 1, blueAccts do 
		blues[i] = account.new("blue", 20, nil, false, 200, 200)
		dbegbal[i] = 20
		physics.addBody( blues[i], static, {density=0, friction=0, bounce=0 } )
		group:insert(blues[i])
--		print("Added a blueacct")
	end

	for i = 1, redAccts do 
		reds[i] = account.new("red", 20, nil, false, 400, 400)
		cbegbal[i] = 20
