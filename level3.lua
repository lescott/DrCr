...
function scene:createScene( event )
	...
	for i = 1, blueAccts do 
		blues[i] = account.new("blue", 20, nil, false, (display.contentWidth/2)-150, display.contentHeight/2)
		dbegbal[i] = 20
	...
	for i = 1, redAccts do 
		reds[i] = account.new("red", 20, nil, false, (display.contentWidth/2)+150, display.contentHeight/2)
		cbegbal[i] = 20
