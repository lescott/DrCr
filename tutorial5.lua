...
function scene:createScene( event )
	...
	local text1 = display.newText("Sometimes, events affect accounts by making them shiny. If you put tokens into shiny accounts, you get bonus points.", 200, 240, 200, 200, native.systemFont, 20)
	...
	local numOfCrs = display.newText("1", cr.x, cr.y+80, native.systemFont, 35)
