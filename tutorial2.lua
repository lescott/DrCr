...
function scene:createScene( event )
	...
	local text1 = display.newText("Red tokens increase red bars.", 200, 275, 200, 200, native.systemFont, 20)
	...
	local text2 = display.newText("Tap this icon to get red tokens. Drag them onto a red bar to increase it.", 200, 1050, 200, 200, native.systemFont, 20)
...
--	numOfDrs:setFillColor(0,0,0)
	local numOfCrs = display.newText(2, cr.x, cr.y+80, native.systemFont, 35)
